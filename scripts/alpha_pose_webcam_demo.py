...
parser.add_argument('--posebatch', type=int, default=30, help='pose estimation maximum batch size PER GPU')
...
parser.add_argument('--qsize', type=int, dest='qsize', default=2048, help='the length of result buffer, where reducing it will lower requirement of cpu memory')
